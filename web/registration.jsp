        ...
        <div class="contact_form gray-bg">
          <form name="myform" action="add_customer.jsp" method="post">
            <div class="form-group">
              ...
              <input type="text"  name="fullname" class="form-control white_bg" placeholder="Full Name" id="fullname" required>
            </div>
            <div class="form-group">
              <label class="control-label">Email Address <span>*</span></label>
              <input type="email" name="email" class="form-control white_bg" placeholder="Email" id="emailaddress" required>
            </div>
            <div class="form-group">
              <label class="control-label">Phone Number <span>*</span></label>
              <input type="number" required maxlength="10" name="contactno" class="form-control white_bg" placeholder="Mobile No" id="phonenumber">
            </div>
            <div class="form-group">
