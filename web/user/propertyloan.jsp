...
<%@ include file = "includes/leftbar.jsp" %>
		<div class="content-wrapper">
			<div class="container-fluid">
                            ...
                            <h2 style="color: red;">property loans:  most important points you should know about</h2>
                            <p>You generally take a property loan for either buying a house/flat or a plot of land for construction of a house, or renovation, extension and repairs to your existing house.
                            </p>
                            <h2>How much loan am I eligible for?</h2>
                            <p>Before you start the property loan process, determine your total eligibility, which will mainly depend on your repaying capacity. Your repayment capacity is based on your monthly disposable/surplus income, which, in turn, is based on factors such as total monthly income/surplus less monthly expenses, and other factors like spouse's income, assets, liabilities, stability of income, etc.
