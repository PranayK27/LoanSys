...
<%@ include file = "includes/leftbar.jsp" %>
		<div class="content-wrapper">
			<div class="container-fluid">
                            <h1>Car Loans</h1>
                            <h2 style="color: red;">car loans:  most important points you should know about</h2>
                            <p>You generally take a car loan for either buying a house/flat or a plot of land for construction of a house, or renovation, extension and repairs to your existing house.
                            </p>
