...
<%@ include file = "includes/leftbar.jsp" %>
		<div class="content-wrapper">
			<div class="container-fluid">
                            <h1>Home Loans</h1>
                            <!--h4 style="color: red;">Home loans: important points you should know</h4-->
                            <!--p>You generally take a home loan for either buying a house/flat or a plot of land for construction of a house, or renovation, extension and repairs to your existing house.
                            </p-->
                            <h4>How much loan am I eligible for?</h4>
                            <p>Before you start the home loan process, determine your total eligibility, which will mainly depend on your repaying capacity. Your repayment capacity is based on your monthly disposable/surplus income, which, in turn, is based on factors such as total monthly income/surplus less monthly expenses, and other factors like spouse's income, assets, liabilities, stability of income, etc.
...
<table class="table table-hover">
                ...
                <tr>
                   <th>BANK NAME</th>
                    <th>HOME RATE OF INTEREST</th>
                </tr>		
               <c:forEach var="row" items="${result.rows}">
                    <tr style="color: #d9534f;font-size:20px;" class="danger">
