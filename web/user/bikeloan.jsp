...
<%@ include file = "includes/leftbar.jsp" %>
		<div class="content-wrapper">
			<div class="container-fluid">
                            <h1>Bike Loans</h1>
                            <h2 style="color: red;">Bike loans:  most important points you should know about</h2>
                            ...
                            <p>Before you start the bike loan process, determine your total eligibility, which will mainly depend on your repaying capacity. Your repayment capacity is based on your monthly disposable/surplus income, which, in turn, is based on factors such as total monthly income/surplus less monthly expenses, and other factors like spouse's income, assets, liabilities, stability of income, etc.
...
<h1> Bike Loan Interest Chart</h1>
     <div id="chart"></div>
